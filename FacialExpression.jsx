...
export default function FacialExpression({ setSongs }) {
    ...
    return (
        <div className="app">
            <div className="card">
                <h1 className="title">Moody Player</h1>
                <p className="subtitle">Let's find a song that matches your vibe.</p>
                ...
                <div>
                    <video
                        ...
                        muted
                         className="circle"
                    />
                    <button onClick={detectMood} className="analyze-btn">Detect Mood</button>
                </div>
            </div>
